...
Info
    Defines SpeedBounds immutable value object for manipulator operating speed limits.
'''
...
class SpeedBounds:
    '''
        Defines operating speed percentage constraints for manipulator movements.
