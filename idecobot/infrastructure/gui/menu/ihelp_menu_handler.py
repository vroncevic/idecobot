...
Info
    Defines structural interface protocol IHelpMenuHandler for help and about actions.
'''
...
@runtime_checkable
class IHelpMenuHandler(Protocol):
    '''
    Structural interface protocol for help menu dialog actions.
