...
Info
    Defines structural interface protocol for factory assembling protocol codec components.
'''
...
@runtime_checkable
class IProtocolCodecFactory(Protocol):
    '''
        Defines structural interface protocol for protocol codec factory.

        It defines:

            :methods:
                | create - Builds and wires a composite MyCobotProtocolCodec facade.
                | get_version - Returns protocol codec factory version string.
    '''

    def create(self, constants: ProtocolConstants) -> MyCobotProtocolCodec:
        '''
