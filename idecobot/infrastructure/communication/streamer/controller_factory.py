...
Info
    Defines ControllerFactory assembling connection, actuator, and telemetry into controller facade.
'''
...
from idecobot.infrastructure.communication.streamer.connection_manager import ConnectionManager
from idecobot.infrastructure.communication.streamer.mycobot_controller import MyCobotController
from idecobot.infrastructure.communication.streamer.robot_actuator import RobotActuator
from idecobot.infrastructure.communication.streamer.robot_telemetry import RobotTelemetry
...
class ControllerFactory:
    '''
        Factory assembling connection, actuation, and telemetry components into controller facade.
    ...
    def create(
        ...
        return MyCobotController(
            connection=ConnectionManager(transport=transport),
            actuator=RobotActuator(transport=transport, codec=codec),
