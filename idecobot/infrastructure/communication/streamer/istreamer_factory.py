...
Info
    Defines structural interface protocol for factory assembling robot streamer components.
'''
...
@runtime_checkable
class IStreamerFactory(Protocol):
    '''
        Defines structural interface protocol for robot streamer factory.
