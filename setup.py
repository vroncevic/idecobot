...
Info
    Defines setup for idecobot package.
'''
...
setup(
    ...
    url='https://github.com/vroncevic/idecobot',
    license='GNU General Public License (GPL)',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='mycobot, robot-arm, dsl, compiler, motion-studio, serial-streamer, ide',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    install_requires=['ats-utilities', 'pyserial'],
    package_data={'idecobot': find_package_data('idecobot')},
    entry_points={
        'console_scripts': [
            'idecobot=main:main'
        ]
