...
| `idecobot/core/model/communication/protocol_constants.py` | 44 | 0 | 100%|
...
| `idecobot/core/service/communication/imycobot_controller.py` | 25 | 0 | 100%|
...
| `idecobot/infrastructure/communication/protocol/motion_codec.py` | 44 | 3 | 93%|
...
| `idecobot/infrastructure/communication/streamer/connection_manager.py` | 24 | 0 | 100%|
| `idecobot/infrastructure/communication/streamer/controller_factory.py` | 23 | 0 | 100%|
| `idecobot/infrastructure/communication/streamer/iconnection_manager.py` | 18 | 0 | 100%|
...
| `idecobot/infrastructure/communication/streamer/mycobot_controller.py` | 44 | 0 | 100%|
...
| `idecobot/infrastructure/communication/transport/mock_serial_transport.py` | 82 | 3 | 96%|
...
| `idecobot/infrastructure/diagnostics/__init__.py` | 9 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/diagnostics_constants.py` | 21 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/diagnostics_coordinator.py` | 43 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/diagnostics_factory.py` | 29 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/idiagnostics_coordinator.py` | 22 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/ijoint_diagnostics_reader.py` | 15 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/iservo_diagnostics_reader.py` | 15 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/ispatial_diagnostics_reader.py` | 15 | 0 | 100%|
| `idecobot/infrastructure/diagnostics/joint_diagnostics_reader.py` | 57 | 3 | 95%|
| `idecobot/infrastructure/diagnostics/servo_diagnostics_reader.py` | 49 | 1 | 98%|
| `idecobot/infrastructure/diagnostics/spatial_diagnostics_reader.py` | 53 | 3 | 94%|
| `idecobot/infrastructure/gui/__init__.py` | 9 | 0 | 100%|
| `idecobot/infrastructure/gui/editor/__init__.py` | 9 | 0 | 100%|
| `idecobot/infrastructure/gui/editor/code_editor.py` | 57 | 3 | 95%|
| `idecobot/infrastructure/gui/editor/editor_constants.py` | 54 | 0 | 100%|
| `idecobot/infrastructure/gui/editor/editor_coordinator.py` | 76 | 1 | 99%|
| `idecobot/infrastructure/gui/editor/editor_panel.py` | 69 | 1 | 99%|
| `idecobot/infrastructure/gui/editor/editor_panel_factory.py` | 60 | 4 | 93%|
| `idecobot/infrastructure/gui/editor/syntax_highlighter.py` | 48 | 0 | 100%|
| `idecobot/infrastructure/gui/engine.py` | 92 | 40 | 57%|
...
| `idecobot/infrastructure/gui/jog/cartesian_panel.py` | 56 | 3 | 95%|
| `idecobot/infrastructure/gui/jog/jog_constants.py` | 60 | 0 | 100%|
| `idecobot/infrastructure/gui/jog/jog_coordinator.py` | 90 | 8 | 91%|
| `idecobot/infrastructure/gui/jog/jog_panel.py` | 50 | 3 | 94%|
| `idecobot/infrastructure/gui/jog/jog_panel_factory.py` | 59 | 8 | 86%|
| `idecobot/infrastructure/gui/jog/joint_constants.py` | 33 | 0 | 100%|
| `idecobot/infrastructure/gui/jog/joint_panel.py` | 56 | 3 | 95%|
| `idecobot/infrastructure/gui/jog/step_constants.py` | 30 | 0 | 100%|
| `idecobot/infrastructure/gui/jog/step_panel.py` | 52 | 8 | 85%|
| `idecobot/infrastructure/gui/jog/tool_constants.py` | 38 | 0 | 100%|
| `idecobot/infrastructure/gui/jog/tool_panel.py` | 53 | 1 | 98%|
| `idecobot/infrastructure/gui/log/__init__.py` | 9 | 0 | 100%|
| `idecobot/infrastructure/gui/log/bytecode_constants.py` | 26 | 0 | 100%|
...
| `idecobot/infrastructure/gui/menu/diagnostics_menu_handler.py` | 36 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/file_menu_handler.py` | 48 | 11 | 77%|
| `idecobot/infrastructure/gui/menu/help_menu_handler.py` | 24 | 2 | 92%|
| `idecobot/infrastructure/gui/menu/idiagnostics_menu_handler.py` | 21 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/ifile_menu_handler.py` | 16 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/ihelp_menu_handler.py` | 15 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/imenu_bar.py` | 19 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/menu_bar.py` | 59 | 7 | 88%|
| `idecobot/infrastructure/gui/menu/menu_bar_constants.py` | 40 | 0 | 100%|
| `idecobot/infrastructure/gui/menu/menu_bar_factory.py` | 52 | 1 | 98%|
...
| `idecobot/infrastructure/gui/setup/factory.py` | 122 | 7 | 94%|
...
| `idecobot/infrastructure/storage/iworkspace_service.py` | 17 | 0 | 100%|
...
| `idecobot/infrastructure/storage/workspace_constants.py` | 17 | 0 | 100%|
| `idecobot/infrastructure/storage/workspace_service.py` | 53 | 5 | 91%|
