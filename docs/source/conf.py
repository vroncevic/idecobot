...
htmlhelp_basename: str = 'idecobotdoc'
latex_elements: dict[object, object] = {}
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'idecobot.tex', 'idecobot Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'idecobot', 'idecobot Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'idecobot', 'idecobot Documentation', author, 'idecobot',
    'Robot IDE and motion studio for Elephant Robotics myCobot 280.', 'Miscellaneous'
)]
